...
class Artista_grupoController {
    lista(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const grupo = yield database_1.default.query('SELECT Codigo, idGrupo, NombreArtistico, Foto, FechaNacimiento, Edad, Instrumento, TipoVoz, Grupo, Periodo FROM Vista_GrupoIntegrantes');
            res.json(grupo);
        });
    }
    crear(req, res) {
