...
class Artista_grupoController{
    public async lista(req: Request, res: Response){
        const grupo = await pool.query('SELECT Codigo, idGrupo, NombreArtistico, Foto, FechaNacimiento, Edad, Instrumento, TipoVoz, Grupo, Periodo FROM Vista_GrupoIntegrantes');
        res.json(grupo);
    }
